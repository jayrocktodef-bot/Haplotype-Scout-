#!/usr/bin/env python3
"""
Comprehensive Uniparental Database Expander for Haplotype Scout.
Integrates new deep African, Indigenous American, Asian, South Asian, and Oceanian markers for Y-DNA and mtDNA.
"""
...
NEW_YDNA_SNPS = """
  ...
  { name: "M180",   rsid: "rs9786237",  chromosome: "Y", position: 21795863, ancestralAllele: "G", derivedAllele: "A", haplogroup: "E-M180",    lineageType: "PATERNAL_YDNA", description: "E-M180 (E1b1a1a) — major West/Central African Niger-Congo expansion patriarch." },
  ...
  { name: "M3",     rsid: "rs3894",     chromosome: "Y", position: 13063360, ancestralAllele: "C", derivedAllele: "T", haplogroup: "Q-M3",      lineageType: "PATERNAL_YDNA", description: "Q-M3 (Q1a2a1a1) — primary pan-American founding Y-chromosome lineage (>80% of Indigenous Americans)." },
  ...
  { name: "P39",    rsid: "rs17244597", chromosome: "Y", position: 9091287,  ancestralAllele: "G", derivedAllele: "A", haplogroup: "C-P39",     lineageType: "PATERNAL_YDNA", description: "C-P39 (C2a1a1) — indigenous North American Na-Dene, Athabaskan, and Algonquian lineage." },

  // ── East & Southeast Asian Y-DNA (O & C2 Subclades)
  { name: "M122",   rsid: "rs9535214",  chromosome: "Y", position: 22091447, ancestralAllele: "A", derivedAllele: "G", haplogroup: "O2-M122",   lineageType: "PATERNAL_YDNA", description: "O2-M122 — dominant Han Chinese and East Asian agricultural expansion lineage." },
  ...
  { name: "M95",    rsid: "rs2032622",  chromosome: "Y", position: 22157156, ancestralAllele: "A", derivedAllele: "C", haplogroup: "O1b1-M95",  lineageType: "PATERNAL_YDNA", description: "O1b1-M95 — Austroasiatic and Southeast Asian mainland founder lineage." },
  { name: "M119",   rsid: "rs2032654",  chromosome: "Y", position: 24892107, ancestralAllele: "A", derivedAllele: "C", haplogroup: "O1a-M119",  lineageType: "PATERNAL_YDNA", description: "O1a-M119 — Austronesian, Taiwanese Indigenous, and Southeast China coastal lineage." },
  ...
  { name: "M69",    rsid: "rs3909",     chromosome: "Y", position: 24045850, ancestralAllele: "C", derivedAllele: "T", haplogroup: "H-M69",     lineageType: "PATERNAL_YDNA", description: "H-M69 (H1) — indigenous South Asian / Indian subcontinent foundational paternal lineage." },
  ...
  { name: "M20",    rsid: "rs3911",     chromosome: "Y", position: 29545897, ancestralAllele: "C", derivedAllele: "T", haplogroup: "L-M20",     lineageType: "PATERNAL_YDNA", description: "L-M20 — Indus Valley Civilization and Iranian Plateau paternal marker." },
  { name: "M479",   rsid: "rs9786762",  chromosome: "Y", position: 21617480, ancestralAllele: "G", derivedAllele: "A", haplogroup: "R2-M479",   lineageType: "PATERNAL_YDNA", description: "R2-M479 — South Asian / Central Asian sister branch to R1." },
  { name: "M184",   rsid: "rs2032658",  chromosome: "Y", position: 25034790, ancestralAllele: "C", derivedAllele: "T", haplogroup: "T-M184",   lineageType: "PATERNAL_YDNA", description: "T-M184 (T1) — Horn of Africa, Near East, and Mediterranean maritime lineage." },
...
NEW_MTDNA_SNPS = """
  ...
  { name: "16217C", rsid: "rs2853566",  chromosome: "MT", position: 16217,  ancestralAllele: "T", derivedAllele: "C", haplogroup: "B2",     lineageType: "MATERNAL_MTDNA", description: "B2 HVR1 defining mutation." },
  ...
  { name: "14668T", rsid: "rs2853581",  chromosome: "MT", position: 14668,  ancestralAllele: "C", derivedAllele: "T", haplogroup: "D4a",    lineageType: "MATERNAL_MTDNA", description: "D4a East Asian / Japanese / Siberian lineage." },
  { name: "6392C",  rsid: "rs2853582",  chromosome: "MT", position: 6392,   ancestralAllele: "T", derivedAllele: "C", haplogroup: "F1a",    lineageType: "MATERNAL_MTDNA", description: "F1a Southeast Asian and South China lineage." },
...
print("Generated database extension blocks.")
